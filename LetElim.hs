...
letElimExpr (Let (n,_) lit@(IntLit i) e2) = letElimExpr e2'
    where e2' = subst n lit e2
letElimExpr (Let (n,_) lit@(BoolLit b) e2) = letElimExpr e2'
    where e2' = subst n lit e2
letElimExpr (Let t e1 e2) = Let t e1' e2'
